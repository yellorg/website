                ...
                <div className="flex w-full max-w-full sm:max-w-1/2 flex-col">
                    ...
                    <div className="flex overflow-visible block">
                        <Tilt
                            ...
                            tiltMaxAngleY={10}
                        >
                            <div className="flex mr-5 w-[25.5rem] h-[35.813rem] border-2 border-text-color-100 items-center rounded-lg bg-primary-cta-color-80 drop-shadow-[0_4.625rem_2.125rem_rgba(166,87,14,0.24)]">
                                <LazyLoadImage
                                ...
                                />
                                <div className="hover:hidden w-full h-full absolute">
                                    <LazyLoadImage
                        ...
                        >
                            <div className="flex mr-5 w-[25.5rem] h-[35.813rem] border-2 border-text-color-100 items-center rounded-lg bg-primary-cta-color-80 drop-shadow-[0_4.625rem_2.125rem_rgba(166,87,14,0.24)]">
                                ...
                                <LazyLoadImage
                                    ...
                                    className="absolute bottom-16"
                                />
                                <span className="absolute bottom-0 right-0 m-4 font-metro-semibold">SWAPPING FOR YELLOW TOKENS</span>
                                <LazyLoadImage
                                    srcSet={`${'/images/components/duckies/sparkles.gif'}`}
                                    threshold={200}
                                    className="absolute mix-blend-color-dodge opacity-50 w-full h-full"
