...
export const DuckiesConnectorModalWindow = (props: DuckiesConnectorModalWindowProps) => {
    ...
    const modalClass = classnames('bg-body-background-color text-text-color-100 relative transition-all ease-in-out duration-200 py-[18px] px-6 w-[350px] border-2 border-text-color-100', {
